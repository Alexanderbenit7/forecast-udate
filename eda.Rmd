...
rmspe = c(0.2794, 0.2778, 0.2794, 0.1838)
r2 = c(0.6912, 0.6863, 0.6912, NA)
...
```{r}
tmodel = c("OLS","Ridge","Lasso","MLP")
rmspe = c(0.2806, 0.2789, 0.2806, NA)
r2 = c(0.6886, 0.6839, 0.6886, NA)
...
combined_plot = rmspe_plot + r2_plot + plot_layout(ncol = 2)
